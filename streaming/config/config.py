...
class ConverterConfig:
    ...
    tflite_model_dst   : str   = "tflite_model"                      # This is the destination directory for the TFLite model.
...
class StreamConfig:
    ...
    default_input_path : str = "/app/streaming/input"              # Path to the directory where the input files are stored.
