...
class PM_model(pl.LightningModule):
    def __init__(self, 
        ...
        self.model = Model_Unet(source=['drums', 'bass', 'other', 'vocals'], depth=4, channel=28)
...
train_set = get_musdb_wav_datasets(musdb='musdb18hq', data_type = 'train', metadata = './metadata', segment=7)
test_set = get_musdb_wav_datasets(musdb='musdb18hq', data_type = 'test', metadata = './metadata1', segment=7)
