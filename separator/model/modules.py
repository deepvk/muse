...
class Encoder(nn.Module):
    def __init__(self, input_channel, out_channel, scale, stride, padding, activation, normalization):
        ...
        self.inception_layer = InceptionBlock(input_channel, out_channel, activation, normalization)
        self.down_layer = DownSample(out_channel*3, out_channel, scale, stride, padding, activation, normalization)
...
class Bottleneck_v2(nn.Module):
    def __init__(self, input_channel, out_channel, activation, normalization,
                 layers=2, max_steps=200, skip=True, stride=1, padding=1 ):
        super().__init__()
